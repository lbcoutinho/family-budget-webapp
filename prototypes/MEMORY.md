...
| 21  | Investment import           | **approved**      | [memory/21-investment-import.md](memory/21-investment-import.md)             |
...
06, 07, 08, 09, 10, 11, 14, 15, 16, 17, 18, 19, 20 and 21 have passed it — those sit in `approved/` and unblock their tickets on the UI side.

...
/**
 * Request body of `PATCH /api/cashboxes/:id` — every editable field of the create body, all optional.
 ...
 */
export class UpdateCashboxDto extends PartialType(OmitType(CreateCashboxDto, ['initialBalance'] as const)) {}
